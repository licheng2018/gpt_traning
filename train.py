#!/usr/bin/env python3
# ============================================================
# Day 3 — Train GPT-Neo-1.3B (Practice) (SKELETON, NO SOLUTION)
# Target: Kaggle 2×T4 first; later move to 4×A100.
#
# What this script should support (YOU implement TODOs):
# - torchrun multi-GPU launch (DDP or FSDP)
# - load dataset (wikitext-103 OR tiny synthetic fallback)
# - tokenize + create fixed-length seq batches (seq_len=512 default)
# - training loop with:
#   * gradient accumulation to hit target global batch
#   * AMP fp16 on T4
#   * loss logging + throughput (tokens/s) + GPU memory stats
# - DDP baseline OR FSDP baseline (full_shard)
#
# Non-goals for Day3:
# - best convergence
# - fancy schedulers
